...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    console.log('sendResetPasswordEmail', user);
    if (!user) {
      return;
    }
...
exports.postForgot = (req, res, next) => {
  ...
  // GET resource
  const userMailjet = mailjet.get('user');

  // POST resource
  const senderMailjet = mailjet.post('sender');
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    return sendEmail
      ...
      .then((response) => {
        ...
        // console.log('messages: ', response.body.Messages);
        // console.log('to: ', response.body.Messages[0].To);
        req.flash('info', {
